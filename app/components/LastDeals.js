...
class LastDeals extends React.Component {
  render() {
    var deals = [
    ...
    var deallist = deals.map(function(deal) {
	    return (
	    <DealsPanel key={deal._id} id={deal._id} cost={deal.cost} item={deal.item} host={deal.host} dist={deal.dist} />
	    )
	});
    return (
	    <div className="panel display">
	    	<div className="text-center">
		    	<h4><b><u>Latest Deals:</u></b></h4>
		    </div>
	        <div className="row">
				{deallist}
		    </div>
